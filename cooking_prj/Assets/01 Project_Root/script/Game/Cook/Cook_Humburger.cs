...
public class Cook_Humburger : CookBase
{

    public E_HumburgerSeq m_CurrentState;
    ...
    public void Awake()
    {
        m_CurrentState = E_HumburgerSeq.R000_010_00;
    ...
    void StateUpdatePlay()
    {
        ...
        {
            case E_HumburgerSeq.R000_010_00:// 재료 준비 0,1,2 재료 클릭 설정 상태 준비 

                break;
            case E_HumburgerSeq.R000_010_10:// 재료 준비 0,1,2 재료 클릭 설정 상태 시작
                PlaySeq_R000_010_10();
                test_EffectOff();
                break;
            case E_HumburgerSeq.R000_010_11:// 재료 준비 0,1,2 재료 클릭 설정 상태 중 대기 

                break;

            case E_HumburgerSeq.R000_010_20: // 재료 준비 0,1,2 재료 클릭 설정 상태 리셋 시작
                PlaySeq_R000_010_20();
                break;
        }
    }
    ...
    public void PlaySeq_R000_010_10()
    {
        ...
        m_CurrentState = E_HumburgerSeq.R000_010_11;
    }
